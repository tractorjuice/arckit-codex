...
2. **Read the template**:
   - `templates-custom/uk-mdr-classification-template.md` → `.arckit/templates-custom/uk-mdr-classification-template.md` → `.arckit/templates/uk-mdr-classification-template.md`
